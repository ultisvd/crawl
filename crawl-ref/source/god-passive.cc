...
static const vector<god_passive> god_passives[] =
{
 ...
 //             "GOD NOW summons jellies to protect you" },
    ...
    // Imus Thea
    {
        { 1, passive_t::imus_fire_illusory_weapon, "can fire a illusory replication of weapon." },
        { 2, passive_t::imus_bounce_wall, "can reflect any projectile on the wall." },
        { 2, passive_t::imus_illusory_ammo, "can fire a illusory replication of ammunition."}
    },
