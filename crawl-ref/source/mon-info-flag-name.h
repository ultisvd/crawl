...
static const vector<monster_info_flag_name> monster_info_flag_names = {
    ...
    { MB_DEFLECT_MSL, "repels missiles", "deflecting missiles", "repel missiles"},
    ...
    { MB_RAISED_MR, "strong-willed", "resistant to hostile enchantments", "strong-willedmr"},
    ...
    { MB_VULN_MAGIC, "weak-willed", "susceptible to hostile enchantments", "weak-willed"},
    { MB_FIRE_VULN, "inflammable", "more vulnerable to fire", "inflammable"},
    { MB_POISON_VULN, "easily poisoned", "vulnerable to poison", "easily poisoned"},
    { MB_MORE_POISON_VULN, "more easily poisoned", "more vulnerable to poison", "more easily poisoned"},
    ...
    { MB_DEATHS_DOOR, "", "standing in death's doorway", ""},
    { MB_CONDENSATION_SHIELD, "", "protected by a disc of dense vapour", ""},
    { MB_CIGOTUVIS_PLAGUE, "", "infected by Cigotuvi's virus", ""},
    { MB_STONESKIN, "stone-skinned", "surrounded by stone skin", "stone-skinned"},
    { MB_NIGREDO, "", "infused by decaying essence of Nigredo", ""},
    { MB_ALBEDO, "", "infused by purging essence of Albedo", ""},
    { MB_CITRINITAS, "", "infused by empowering essence of Cirtintas", ""},
