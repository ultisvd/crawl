...
enum ability_type
{
    ...
    ABIL_NEMELEX_DRAW_WONDER,
        ABIL_NEMELEX_LAST_DECK = ABIL_NEMELEX_DRAW_WONDER,
    // Beogh
    ABIL_BEOGH_SMITING = 1120,
    ABIL_BEOGH_RECALL_ORCISH_FOLLOWERS,
    ABIL_BEOGH_GIFT_ITEM,
    ABIL_BEOGH_RESURRECTION,
    ABIL_BEOGH_RETURN_ORCISH_FOLLOWERS,
    // Jiyva
    ...
    ABIL_JIYVA_BLESS_WEAPON,
    ABIL_JIYVA_CORROSION_DUNGEON,
    // Fedhas
    ...
    ABIL_RU_SACRIFICE_NECK,
        ABIL_FINAL_SACRIFICE = ABIL_RU_SACRIFICE_NECK,
    ...
    ABIL_PAKELLAS_PROTOTYPE,
    ABIL_PAKELLAS_UPGRADE,
    ...
    ABIL_WYRM_VIRIDITAS,
    ABIL_WYRM_RUBEDO,
    ABIL_WYRM_FULSOME_DISTILLATION,
    ABIL_WYRM_EVAPORATE,
    ...
    //Agraphede
    ABIL_AGRAPHEDE_WEB = 1320,
    ABIL_AGRAPHEDE_CONVERT_POISON,
    ABIL_AGRAPHEDE_ENCHANT_POISON,
    ABIL_AGRAPHEDE_TRAP,
    ABIL_AGRAPHEDE_HORNET_STING,
    ABIL_AGRAPHEDE_SUMMON_SPIDER,
