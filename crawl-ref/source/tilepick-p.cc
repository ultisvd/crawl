...
tileidx_t tileidx_player()
{
    ...
    case transformation::holy_swine:ch = TILEP_TRAN_HOLY_SWINE;break;
#if TAG_MAJOR_VERSION == 34
...
tileidx_t tilep_species_to_base_tile(int sp, int level)
{
    ...
    case SP_TWO_HEADED_OGRE:
        return TILEP_BASE_TWO_HEADED_OGRE;
    case SP_TROLL:
...
void tilep_race_default(int sp, int level, dolls_data *doll)
{
    ...
    switch (sp)
    {
        ...
        case SP_MOUNTAIN_DWARF:
            ...
            beard = TILEP_BEARD_GARIBALDI_RED;
            break;
        case SP_SPRIGGAN:
            hair = 0;
...
void tilep_job_default(int job, dolls_data *doll)
{
    ...
    switch (job)
    {
        ...
        case JOB_MELTED_KNIGHT:
            parts[TILEP_PART_BODY] = TILEP_BODY_SHOULDER_PAD;
            parts[TILEP_PART_LEG] = TILEP_LEG_METAL_GRAY;
            parts[TILEP_PART_ARM] = TILEP_ARM_GLOVE_BLUE;
            parts[TILEP_PART_BOOTS] = TILEP_BOOTS_MIDDLE_GREEN;
            break;
