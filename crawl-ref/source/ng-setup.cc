...
static void _give_ammo(weapon_type weapon, int plus)
{
    ...
    case WPN_THROWN:
        ...
        break;
    case WPN_SHORTBOW:
        newgame_make_item(OBJ_MISSILES, MI_ARROW, 60);
        break;
    case WPN_HAND_CROSSBOW:
        newgame_make_item(OBJ_MISSILES, MI_BOLT, 60);
        break;
    case WPN_HUNTING_SLING:
        newgame_make_item(OBJ_MISSILES, MI_SLING_BULLET, 60);
        break;
    default:
        break;
    }
...
void give_items_skills(const newgame_def& ng)
{
    ...
    if (you.species == SP_TWO_HEADED_OGRE || you.species == SP_CRUSTACEAN || you.species == SP_HYDRA)
    {
        you.skills[SK_SHIELDS] = 0;
    }
