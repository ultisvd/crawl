...
//{  4,  6,    4, SEMI, MONS_ANCIENT_LICH },
  ...
  {  1,  7,  475, FLAT, MONS_TORMENTOR },
  {  1,  7,  300, FLAT, MONS_CUBUS },
...
{ // Gehenna
  ...
  {  1,  7,  265, FLAT, MONS_TORMENTOR },
  {  1,  7,  100, FLAT, MONS_CUBUS },
...
{ // Cocytus
  ...
  {  1,  7,  185, FLAT, MONS_TORMENTOR },
  {  1,  7,  100, FLAT, MONS_INTERDIMENSIONAL_GRAPE },
...
{ // Tartarus
  ...
  {  1,  7,  165, FLAT, MONS_TORMENTOR },
  {  1,  7,  200, FLAT, MONS_CUBUS },
  {  1,  7,  365, FLAT, MONS_HELLION },
  {  1,  7,  365, FLAT, MONS_SHADOW_DEMON },
  {  1,  7,  130, SEMI, MONS_GHOST_CRAB },
  {  1,  7,  100, FLAT, MONS_INTERDIMENSIONAL_GRAPE },
...
{ // Abyss
  ...
  {  1,  5,  335, FLAT, MONS_INTERDIMENSIONAL_GRAPE },
  ...
  {  1,  5,   11, FLAT, MONS_TORMENTOR },
  {  1,  5,   10, FLAT, MONS_CUBUS },
...
{ // Pandemonium - only used for 1 in 40 random Pan spawns (the rest are drawn
  ...
  {  1,  1,   50, FLAT, MONS_INTERDIMENSIONAL_GRAPE },
...
{ // Forge of Golems
  {  1,  1,   70, FLAT, MONS_ELECTRIC_GOLEM },
  {  1,  1,  300, FLAT, MONS_CRYSTAL_GUARDIAN },
  {  1,  1,  385, FLAT, MONS_IRON_GOLEM },
  { 0,0,0,FLAT,MONS_0 }
};
