...
{ // Dungeon (OOD cap: 27)
  ...
  {  6, 12,  755, PEAK, MONS_ORC_WARRIOR },
  ...
  {  9, 14,  192, PEAK, MONS_VAMPIRE },
  { 10, 13,  350, PEAK, MONS_UNSEEN_HORROR },
  { 10, 13,  200, PEAK, MONS_KOMODO_DRAGON },
  { 10, 14,  370, PEAK, MONS_GARGOYLE },
  { 10, 15,  500, PEAK, MONS_VAMPIRE_MOSQUITO },
  { 10, 16,  120, PEAK, MONS_SOLDIER_ANT },
  { 11, 18,  750, PEAK, MONS_UGLY_THING },
...
#endif
    GENERIC_WATER_POP, // Forge of Golems
    GENERIC_WATER_POP, // HIVE
};
...
static const vector<pop_entry> population_lava[] =
{
    ...
    GENERIC_LAVA_POP, // Gauntlet
#endif
    GENERIC_LAVA_POP, // Forge of Golems
    GENERIC_LAVA_POP, // Hive
};
