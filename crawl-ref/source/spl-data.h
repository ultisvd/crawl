...

{
    ...
    spschool::conjuration,
    spflag::target | spflag::area | spflag::unholy | spflag::needs_tracer | spflag::monster,
    9,
    200,
    LOS_RADIUS, LOS_RADIUS,
    9, 0,
...
{
    SPELL_ALLURE_OF_CUBUS, "Nightmare of Cubus",
    spschool::hexes,
    spflag::target | spflag::not_self | spflag::unholy | spflag::monster,
    6,
    0,
    LOS_RADIUS, LOS_RADIUS,
    0, 0,
...

{
    ...
    spschool::hexes,
    spflag::dir_or_target | spflag::needs_tracer | spflag::MR_check | spflag::monster,
    5,
    200,
    LOS_RADIUS, LOS_RADIUS,
    4, 0,
...

{
    ...
    spschool::necromancy,
    spflag::dir_or_target | spflag::not_self | spflag::needs_tracer | spflag::monster,
    5,
    200,
    LOS_RADIUS, LOS_RADIUS,
    4, 10,
...

{
    ...
    spflag::dir_or_target | spflag::not_self | spflag::helpful | spflag::monster,
    6,
    200,
    LOS_RADIUS, LOS_RADIUS,
    5, 0,
...

{
    ...
    spschool::conjuration,
    spflag::dir_or_target | spflag::chaotic | spflag::needs_tracer | spflag::monster,
    7,
    200,
    6, 6,
    7, 0,
...
{
    SPELL_MASS_BARRIER, "Mass Barrier",
    spschool::charms,
    spflag::emergency | spflag::utility | spflag::no_ghost,
    5,
    200,
...

{
    SPELL_DISARM, "Disarm",
    spschool::hexes,
    spflag::dir_or_target | spflag::needs_tracer| spflag::not_self | spflag::MR_check | spflag::monster,
    5,
    200,
    LOS_RADIUS, LOS_RADIUS,
    4, 0,
