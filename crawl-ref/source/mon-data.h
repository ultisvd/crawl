...

{
    ...
    MR_NO_FLAGS,
    10, MONS_HOUND, MONS_FIRE_FOX, MH_NATURAL, 10,
    { {AT_BITE, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 165,
    1, 15, MST_FIRE_FOX, CE_CLEAN, S_BARK,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED,
    {TILEP_MONS_FIRE_FOX}, TILE_CORPSE_FIRE_FOX
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 495,
    0, 10, MST_IRONBOUND_CONVOKER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    12, 600,
    0, 10, MST_IRONBOUND_FROSTHEART, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 1120,
    0, 6, MST_IRONBOUND_PRESERVER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    M_NO_SKELETON | M_FLIES,
    MR_VUL_POISON,
    1, MONS_KILLER_BEE, MONS_KILLER_BEE_LARVA, MH_NATURAL, 0,
    { {AT_BITE, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 25,
    1, 5, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_ANIMAL, HT_LAND, 5, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_INSECT,
    {TILEP_MONS_KILLER_BEE_LARVA}, TILE_CORPSE_KILLER_BEE_LARVA
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 40}, {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK },
    12, 660,
...
},
{
    ...
    M_ANCESTOR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES | M_FAST_REGEN | M_INSUBSTANTIAL | M_SEE_INVIS | M_DONT_MELEE,
    MR_RES_FIRE | MR_RES_COLD,
...
// jellies ('J')
{
    ...
    1, 60,
    1, 3, MST_ENDOPLASM, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_SEE_INVIS | M_UNBLINDABLE | M_EAT_DOORS,
    MR_RES_POISON | mrd(MR_RES_ACID, 3),
    13, MONS_JELLY, MONS_QUICKSILVER_OOZE, MH_NATURAL, MAG_IMMUNE,
    { {AT_HIT, AF_ENGULF, 27}, {AT_HIT, AF_ANTIMAGIC, 15}, AT_NO_ATK, AT_NO_ATK },
    13, 650,
    3, 15, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 16, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_BLOB,
...
{
    MONS_SMALL_JELLY, 'j', LIGHTRED, "small jelly",
    M_SEE_INVIS | M_UNBLINDABLE | M_SPLITS,
    MR_RES_POISON | mrd(MR_RES_ACID, 3),
    3, MONS_JELLY, MONS_SMALL_JELLY, MH_NATURAL, 10,
    { {AT_HIT, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 80,
    0, 1, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_BLOB,
    {TILEP_MONS_SMALL_JELLY}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 32}, {AT_CONSTRICT, AF_CRUSH, 6},
       AT_NO_ATK, AT_NO_ATK },
    10, 1000,
    6, 10, MST_NAGA_WARRIOR, CE_NOXIOUS, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(14),
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_NAGA,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 880,
    1, 8, MST_IRONBOUND_THUNDERHULK, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
{
    MONS_HOODED_MALICE, 'W', LIGHTCYAN, "hooded malice",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES | M_SPINY,
    MR_RES_COLD,
    14, MONS_WRAITH, MONS_HOODED_MALICE, MH_UNDEAD, 80,
    { {AT_HIT, AF_DRAIN_XP, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 440,
    12, 10, MST_HOODED_MALICE, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_HOODED_MALICE}, TILE_ERROR
},
...
{
    MONS_LIVELY_MASS, 'X', GREEN, "lively mass",
    M_NO_EXP_GAIN | M_NO_REGEN,
    mrd(MR_RES_NEG, 3),
    12, MONS_LIVELY_MASS, MONS_LIVELY_MASS, MH_NONLIVING, 100,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 500,
    10, 0, MST_LIVELY_MASS, CE_NOCORPSE, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_MISC,
    {TILEP_MONS_LIVELY_MASS}, TILE_ERROR
},

{
    MONS_PLAYER_ELDRITCH_TENTACLE, 'w', LIGHTCYAN, "horrible tentacle",
    M_NO_EXP_GAIN | M_STATIONARY | M_NO_POLY_TO | M_FLIES | M_SEE_INVIS,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC
        | MR_RES_ACID, 3) | MR_RES_STICKY_FLAME,
    10, MONS_PLAYER_ELDRITCH_TENTACLE, MONS_PLAYER_ELDRITCH_TENTACLE,
        MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 25}, {AT_CONSTRICT, AF_CRUSH, 3}, AT_NO_ATK, AT_NO_ATK },
    16, 1200,
...
{
    MONS_PLAYER_ELDRITCH_TENTACLE_SEGMENT, '*', LIGHTCYAN, "horrible tentacle segment",
    M_NOT_DANGEROUS | M_STATIONARY | M_NO_POLY_TO | M_FLIES | M_SEE_INVIS,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC
        | MR_RES_ACID, 3) | MR_RES_STICKY_FLAME,
    10, MONS_PLAYER_ELDRITCH_TENTACLE, MONS_PLAYER_ELDRITCH_TENTACLE_SEGMENT,
        MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 1200,
    13, 0, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
...

{
    ...
    15, 675,
    5, 7, MST_SALAMANDER_TYRANT, CE_CLEAN, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, SWIM_ENERGY(7),
...
{
    MONS_IMUS_MIRROR, '@', WHITE, "fragmentation",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_NO_EXP_GAIN | M_NO_POLY_TO
        | M_MAINTAIN_RANGE | M_AVATAR | M_FLIES | M_UNBLINDABLE | M_GHOST_DEMON,
    mrd(MR_RES_COLD | MR_RES_FIRE, 2) | mrd(MR_RES_ELEC, 3)
        | MR_RES_ACID | MR_RES_STICKY_FLAME,
    15, MONS_IMUS_MIRROR, MONS_IMUS_MIRROR, MH_NATURAL, -5,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 150,
    1, 2, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 30, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_PLAYER_GHOST}, TILE_ERROR
},
...
{
    MONS_ANIMATED_ARMOUR_SPELL, '[', GREEN, "animated armour",
    M_NO_FLAGS,
    MR_NO_FLAGS,
    10, MONS_ANIMATED_ARMOUR_SPELL, MONS_ANIMATED_ARMOUR_SPELL, MH_NONLIVING, MAG_IMMUNE,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    8, 12, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
    MONS_CUBUS, '2', CYAN, "cubus",
    M_SEE_INVIS | M_SPEAKS,
    MR_RES_POISON | MR_RES_COLD | MR_RES_FIRE | MR_RES_ELEC,
    10, MONS_CUBUS, MONS_CUBUS, MH_DEMONIC, 140,
    { {AT_TOUCH, AF_VAMPIRIC, 8}, {AT_TOUCH, AF_ANTIMAGIC, 8}, AT_NO_ATK, AT_NO_ATK },
    7, 385,
    12, 12, MST_CUBUS, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_PROGRAM_BUG}, TILE_ERROR
},
...
{
    MONS_MACHINE_GOLEM, '8', LIGHTGREY, "machine golem",
    M_NO_POLY_TO | M_NO_EXP_GAIN,
    MR_RES_PETRIFY,
    10, MONS_MACHINE_GOLEM, MONS_MACHINE_GOLEM, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    10, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_MISC,
    {TILEP_MONS_MACHINE_GOLEM}, TILE_ERROR
},

{
    MONS_BARRICADE, '8', BROWN, "barricade",
    M_STATIONARY | M_NO_POLY_TO,
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | mrd(MR_RES_ELEC, 3) | MR_RES_PETRIFY | MR_RES_POISON,
    10, MONS_BARRICADE, MONS_BARRICADE, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 150,
    15, 0, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_MISC,
    {TILEP_MONS_BARRICADE}, TILE_ERROR
},

{
    MONS_PAVISE, ']', CYAN, "shield",
    M_STATIONARY | M_NO_POLY_TO,
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | mrd(MR_RES_ELEC, 3) | MR_RES_PETRIFY | MR_RES_POISON,
    10, MONS_PAVISE, MONS_PAVISE, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 150,
    10, 0, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_MISC,
    {TILEP_MONS_PAVISE}, TILE_ERROR
},
...
{// Base dummy for golemforge
    MONS_ANIMATED_ARMOUR, '9', LIGHTCYAN, "animated armours",
    M_SEE_INVIS | M_FIGHTER | M_FLIES | M_NO_GEN_DERIVED | M_NO_POLY_TO,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 3),
    10, MONS_GOLEM, MONS_IRON_GOLEM, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 950,
    2, 4, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, SPELL_ENERGY(20),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_WAR_GARGOYLE}, TILE_ERROR
},
...
{ // not an actual monster, used by a spell
    MONS_WILL_O_WISP, 'v', LIGHTBLUE, "will-o'-wisp",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_NOT_DANGEROUS | M_NO_POLY_TO
        | M_CONJURED | M_FLIES,
    mrd(MR_RES_FIRE, 3) | mrd(MR_RES_NEG, 3) | MR_RES_STICKY_FLAME,
    0, MONS_FOXFIRE, MONS_WILL_O_WISP, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_DRAIN_XP, 1}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    20, 10, /* unkillable */
    0, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 50, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_ORB,
    {TILEP_MONS_WILL_O_WISP}, TILE_ERROR
},

{
    MONS_BALL_WEB, '*', WHITE, "ball of web",
    M_INSUBSTANTIAL | M_CONJURED | M_FLIES,
    mrd(MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD, 3) | MR_RES_TORNADO,
    20, MONS_BALL_WEB, MONS_BALL_WEB, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 10,
    0, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_ORB,
    {TILEP_MONS_BALL_WEB}, TILE_ERROR
},
...
{ // not an actual monster, used by a spell
    MONS_PRISMATIC_PRISM, '*', ETC_MAGIC, "prismatic prism",
    M_NO_POLY_TO | M_STATIONARY | M_CONJURED | M_NO_EXP_GAIN
        | M_FLIES,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
    0, MONS_FULMINANT_PRISM, MONS_FULMINANT_PRISM, MH_NONLIVING, MAG_IMMUNE,
    ...
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_ORB,
    {TILEP_MONS_PRISMATIC_PRISM, TVARY_RANDOM}, TILE_ERROR
},
...
{
    MONS_INTERDIMENSIONAL_GRAPE, '%', MAGENTA, "interdimensional grape",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
    MR_NO_FLAGS,
    13, MONS_INTERDIMENSIONAL_GRAPE, MONS_INTERDIMENSIONAL_GRAPE, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 700,
    10, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, MOVE_ENERGY(8),
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_ORB,
    {TILEP_MONS_INTERDIMENSIONAL_GRAPE}, TILE_ERROR
},
...
{
    MONS_FALLEN, 'A', LIGHTCYAN, "Fallen",
    M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_UNIQUE | M_FEMALE | M_FLIES,
    MR_RES_COLD | MR_RES_ELEC,
    10, MONS_ANGEL, MONS_PROFANE_SERVITOR, MH_UNDEAD, 140,
    { {AT_HIT, AF_VAMPIRIC, 25}, {AT_HIT, AF_DRAIN_XP, 25}, AT_NO_ATK,
       AT_NO_ATK },
    18, 1600,
    16, 25, MST_FALLEN, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED,
    {TILEP_MONS_FALLEN}, TILE_ERROR
},
...
{
    MONS_SPIRIT_FOX, 'h', CYAN, "Spirit fox the nine-tailed",
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_UNIQUE | M_FEMALE | M_UNBLINDABLE | M_BLOOD_SCENT,
    mrd(MR_RES_NEG, 3),
    18, MONS_HOUND, MONS_FIRE_FOX, MH_NATURAL, 100,
    { {AT_BITE, AF_ANTIMAGIC, 30}, {AT_BITE, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK },
    20, 1850,
    22, 4, MST_SPIRIT_FOX, CE_CLEAN, S_BARK,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_QUADRUPED,
    {TILEP_MONS_SPIRIT_FOX}, TILE_ERROR
},
...
{
    MONS_BLORK_THE_ORC_WARRIOR, 'o', BROWN, "Blork the orc warrior",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    16, MONS_ORC, MONS_ORC, MH_NATURAL, 20,
    { {AT_HIT, AF_PLAIN, 22}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_BLORK_THE_ORC_WARRIOR}, TILE_ERROR
},

{
    MONS_BLORK_THE_ORC_KNIGHT, 'o', BROWN, "Blork the orc knight",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    9, MONS_ORC, MONS_ORC, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 1210,
    2, 12, MST_BLORK, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_BLORK_THE_ORC_KNIGHT}, TILE_ERROR
},

{
    MONS_BLORK_THE_ORC_WARLORD, 'o', BROWN, "Blork the orc warlord",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    11, MONS_ORC, MONS_ORC, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 34}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    17, 1870,
    3, 9, MST_BLORK, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_BLORK_THE_ORC_WARLORD}, TILE_ERROR
},
...
//orchish culverin
{
    MONS_URUG_II, 'o', RED, "Urug the Orcish Culverin",
    M_UNIQUE | M_FIGHTER | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    17, MONS_ORC, MONS_ORC, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 32}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 1125,
    9, 10, MST_URUG, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_URUG_II}, TILE_ERROR
},
...
//the Deathmonger
{
    MONS_NERGALLE_II, 'o', WHITE, "Nergalle the Deathbinder",
    M_UNIQUE | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    12, MONS_ORC, MONS_ORC, MH_NATURAL | MH_EVIL, 60,
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 900,
    9, 11, MST_NERGALLE_II, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_NERGALLE_II}, TILE_ERROR
},

{
    MONS_ASCLEPIA, 'o', LIGHTGREEN, "Asclepia",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MAINTAIN_RANGE | M_FEMALE,
    MR_NO_FLAGS,
    15, MONS_ORC, MONS_ORC, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 650,
    5, 9, MST_ASCLEPIA, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ASCLEPIA}, TILE_ERROR
},

//the Anointer
{
    MONS_ASCLEPIA_II, 'o', LIGHTGREEN, "Asclepia the Anointer",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MAINTAIN_RANGE | M_FEMALE,
    MR_NO_FLAGS,
    15, MONS_ORC, MONS_ORC, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 975,
    5, 9, MST_ASCLEPIA_II, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ASCLEPIA_II}, TILE_ERROR
},

{
    MONS_BRANDAGOTH, 'o', DARKGREY, "Brandagoth",
    M_UNIQUE | M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD,
    mrd(MR_RES_FIRE, 3) | MR_VUL_COLD,
    13, MONS_ORC, MONS_ORC, MH_NATURAL, 80,
    { {AT_HIT, AF_FIRE, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 800,
    12, 6, MST_BRANDAGOTH, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_BRANDAGOTH}, TILE_ERROR
},

// the Flame of Beogh
{
    MONS_BRANDAGOTH_II, 'o', RED, "Brandagoth the Flame",
    M_UNIQUE | M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD,
    mrd(MR_RES_FIRE, 3) | MR_VUL_COLD | MR_RES_DAMNATION,
    13, MONS_ORC, MONS_ORC, MH_NATURAL | MH_EVIL, 80,
    { {AT_HIT, AF_FIRE, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    17, 1000,
    12, 6, MST_BRANDAGOTH_II, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_BRANDAGOTH_II}, TILE_ERROR
},
...
{
    MONS_LICHBANE, 'z', LIGHTCYAN, "Lichbane",
    M_UNIQUE | M_NO_REGEN | M_SPEAKS,
    MR_RES_COLD,
    24, MONS_ANCIENT_CHAMPION, MONS_ANCIENT_CHAMPION, MH_UNDEAD, 120,
    { {AT_HIT, AF_PLAIN, 36}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 1400,
    10, 10, MST_LICHBANE, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_LICHBANE}, TILE_ERROR
},
...
{
    MONS_RIN, '@', CYAN, "Rin the nine-tailed",
    M_UNIQUE | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    mrd(MR_RES_NEG, 3),
    16, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 100,
    { {AT_HIT, AF_PLAIN, 24}, {AT_HIT, AF_ANTIMAGIC, 14}, AT_NO_ATK,
       AT_NO_ATK },
    20, 1850,
    14, 8, MST_RIN, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID_TAILED,
    {TILEP_MONS_RIN}, TILE_ERROR
},

// mercenaries for JOB_CARAVAN
{
    MONS_MERC_FIGHTER, 'p', LIGHTGREY, "hired soldier",
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 20,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 350,
    2, 5, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_FIGHTER}, TILE_ERROR
},

{
    MONS_MERC_KNIGHT, 'p', CYAN, "hired knight",
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 700,
    4, 5, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_VAULT_GUARD}, TILE_ERROR
},
...
{
    MONS_MERC_DEATH_KNIGHT, 'p', GREEN, "hired death knight",
    M_WARM_BLOOD | M_FIGHTER | M_SPEAKS | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 100,
    { {AT_HIT, AF_VAMPIRIC, 28}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 900,
    6, 5, MST_MERC_DEATH_KNIGHT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_DEATH_KNIGHT}, TILE_ERROR
},
...
{
    MONS_MERC_PALADIN, 'p', WHITE, "hired paladin",
    M_WARM_BLOOD | M_FIGHTER | M_SPEAKS | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 100,
    { {AT_HIT, AF_HOLY, 28}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 900,
    8, 5, MST_MERC_PALADIN, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_PALADIN}, TILE_ERROR
},

{
    MONS_MERC_SKALD, 'm', LIGHTBLUE, "hired skald",
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_MERFOLK, MONS_MERFOLK, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 300,
    0, 10, MST_MERC_SKALD, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_SKALD, TVARY_WATER}, TILE_CORPSE_MERFOLK
},

{
    MONS_MERC_INFUSER, 'm', YELLOW, "hired infuser",
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_MERFOLK, MONS_MERFOLK, MH_NATURAL, 80,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    1, 15, MST_MERC_INFUSER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_INFUSER, TVARY_WATER}, TILE_ERROR
},

{
    MONS_MERC_TIDEHUNTER, 'm', WHITE, "hired tidehunter",
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_MERFOLK, MONS_MERFOLK, MH_NATURAL, 120,
    { {AT_HIT, AF_PLAIN, 24}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 700,
    2, 25, MST_MERC_TIDEHUNTER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_TIDEHUNTER, TVARY_WATER}, TILE_ERROR
},

{
    MONS_MERC_WITCH, 'e', LIGHTMAGENTA, "hired witch",
    M_WARM_BLOOD | M_SPEAKS | M_DONT_MELEE | M_MAINTAIN_RANGE | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_ELF, MONS_ELF, MH_NATURAL, 80,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 250,
    0, 5, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_WITCH}, TILE_ERROR
},

{
    MONS_MERC_SORCERESS, 'e', MAGENTA, "hired sorceress",
    M_WARM_BLOOD | M_SPEAKS | M_DONT_MELEE | M_MAINTAIN_RANGE | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_ELF, MONS_ELF, MH_NATURAL, 160,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 400,
    0, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_SORCERESS}, TILE_ERROR
},

{
    MONS_MERC_ELEMENTALIST, 'e', LIGHTRED, "hired archmage",
    M_WARM_BLOOD | M_SPEAKS | M_DONT_MELEE | M_MAINTAIN_RANGE | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC ,
    10, MONS_ELF, MONS_ELF, MH_NATURAL, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 550,
    0, 15, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_ELEMENTALIST}, TILE_ERROR
},

{
    MONS_MERC_BRIGAND, 'K', YELLOW, "hired brigand",
    M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD | M_BLOOD_SCENT | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_KOBOLD, MONS_KOBOLD, MH_NATURAL, 30,
    { {AT_HIT, AF_SHADOWSTAB, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 275,
    0, 10, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_BRIGAND}, TILE_ERROR
},

{
    MONS_MERC_ASSASSIN, 'K', LIGHTGREEN, "hired assassin",
    M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD | M_BLOOD_SCENT | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_KOBOLD, MONS_KOBOLD, MH_NATURAL, 60,
    { {AT_HIT, AF_SHADOWSTAB, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 500,
    1, 15, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_ASSASSIN}, TILE_ERROR
},

{
    MONS_MERC_CLEANER, 'K', GREEN, "hired cleaner",
    M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD | M_BLOOD_SCENT | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_KOBOLD, MONS_KOBOLD, MH_NATURAL, 120,
    { {AT_HIT, AF_SHADOWSTAB, 18}, {AT_HIT, AF_SHADOWSTAB, 12}, AT_NO_ATK, AT_NO_ATK },
    15, 650,
    2, 25, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_CLEANER}, TILE_ERROR
},

{
    MONS_MERC_SHAMAN, 'g', BROWN, "hired shaman",
    M_SPEAKS | M_WARM_BLOOD | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_GNOLL, MONS_GNOLL, MH_NATURAL, 20,
    { {AT_HIT, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 250,
    3, 3, MST_MERC_SHAMAN, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_SHAMAN}, TILE_ERROR
},

{
    MONS_MERC_SHAMAN_II, 'g', YELLOW, "hired ritualist",
    M_SPEAKS | M_WARM_BLOOD | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_GNOLL, MONS_GNOLL, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 500,
    6, 6, MST_MERC_SHAMAN_II, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, SPELL_ENERGY(8),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_SHAMAN_II}, TILE_ERROR
},

{
    MONS_MERC_SHAMAN_III, 'g', LIGHTRED, "hired chieftain",
    M_SPEAKS | M_WARM_BLOOD | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_MERC_ONLY,
    MR_NO_FLAGS,
    10, MONS_GNOLL, MONS_GNOLL, MH_NATURAL, 100,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 800,
    9, 9, MST_MERC_SHAMAN_III, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, SPELL_ENERGY(5),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_MERC_SHAMAN_III}, TILE_ERROR
},
