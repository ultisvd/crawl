...

{
    ...
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 700,
...

{
    ...
    M_WARM_BLOOD | M_FIGHTER | M_SPEAKS | M_NO_POLY_TO | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 100,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS | M_NO_POLY_TO | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
    10, MONS_MERFOLK, MONS_MERFOLK, MH_NATURAL, 120,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_DONT_MELEE | M_MAINTAIN_RANGE | M_NO_POLY_TO | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
    10, MONS_ELF, MONS_ELF, MH_NATURAL, 80,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 250,
...

{
    ...
    M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD | M_BLOOD_SCENT | M_NO_POLY_TO | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
