...
static const mon_spellbook mspell_list[] =
{
    ...
    { MST_FIRE_FOX,
      {
        { SPELL_FOXFIRE, 39, MON_SPELL_NATURAL },
        { SPELL_BLINK , 6, MON_SPELL_WIZARD | MON_SPELL_EMERGENCY }
      }
    },

    { MST_SPIRIT_FOX,
      {
        { SPELL_FOXFIRE, 13, MON_SPELL_NATURAL },
        { SPELL_ISKENDERUNS_MYSTIC_BLAST, 39, MON_SPELL_WIZARD },
        { SPELL_BATTLESPHERE, 39, MON_SPELL_WIZARD },
        { SPELL_BLINK, 26, MON_SPELL_WIZARD | MON_SPELL_EMERGENCY },
      }
    },
   ...
   {  MST_NERGALLE_II,
    ...
    { MST_RIN,
      {
        { SPELL_ISKENDERUNS_MYSTIC_BLAST, 65, MON_SPELL_WIZARD },
        { SPELL_BATTLESPHERE, 65, MON_SPELL_WIZARD },
    ...
    {  MST_MERC_SKALD,
      {
       ...
       { SPELL_REGENERATION, 12, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_MERC_INFUSER,
      {
       ...
       { SPELL_OZOCUBUS_ARMOUR, 12, MON_SPELL_WIZARD },
       { SPELL_REGENERATION, 12, MON_SPELL_WIZARD },
       { SPELL_SPECTRAL_WEAPON, 24, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_MERC_CLEANER,
      {
       ...
       { SPELL_BLINK_CLOSE, 66, MON_SPELL_PRIEST | MON_SPELL_SHORT_RANGE },
       { SPELL_BLINK_RANGE, 33, MON_SPELL_PRIEST | MON_SPELL_EMERGENCY },
      }
    },

    {  MST_MERC_SHAMAN,
      {
       { SPELL_CORONA, 21, MON_SPELL_PRIEST },
       { SPELL_HEAL_OTHER, 11, MON_SPELL_PRIEST },
       { SPELL_MINOR_HEALING, 11, MON_SPELL_PRIEST | MON_SPELL_EMERGENCY },
      }
    },
    ...
    {  MST_MERC_SHAMAN_II,
      {
       { SPELL_SLOW, 21, MON_SPELL_PRIEST },
       { SPELL_STRIP_RESISTANCE, 21, MON_SPELL_PRIEST },
       { SPELL_HEAL_OTHER, 11, MON_SPELL_PRIEST },
       { SPELL_MINOR_HEALING, 11, MON_SPELL_PRIEST | MON_SPELL_EMERGENCY },
      }
    },
    ...
    {  MST_MERC_SHAMAN_III,
      {
       { SPELL_HASTE, 21, MON_SPELL_PRIEST },
       { SPELL_SLOW, 21, MON_SPELL_PRIEST },
       { SPELL_STRIP_RESISTANCE, 21, MON_SPELL_PRIEST },
       { SPELL_HASTE_OTHER, 11, MON_SPELL_PRIEST },
       { SPELL_HEAL_OTHER, 21, MON_SPELL_PRIEST },
