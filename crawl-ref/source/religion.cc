...
//           "Cheibriados is no longer ready to bless your weapon." },
    ...
    { { 0, "The Legion will resist abjuration." },
      ...
      { 2, "The Legion will leave magical essence.",
           "The Leigon no longer leave magical essence." },
      { 3, "The Legion will inspired by killing.",
           "The Leigon no longer inspired by killing." },
      { 5, ABIL_LEGION_IMMORTAL, "force your servants not to die briefly",
